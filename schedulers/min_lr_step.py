class MinCapableStepLR:
    ...
    def step(self):
        ...
        if self.is_time_to_update_lr():
            ...
            print("Updating LR for optimizer")
    ...
    def update_lr(self):
        ...
        # else:
            ...
            print("WARNING: Updating LR would place it below min LR. Skipping LR update.")

        # self.logger.debug("New LR: {}".format(self.optimizer.param_groups[0]['lr']))
        print("New LR: {}".format(self.optimizer.param_groups[0]['lr']))
